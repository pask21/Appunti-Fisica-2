...
\begin{align}
  \v{P}(\v{r}, t) = \frac1{4\pi k_e} \chi_e \,\v{E}(\v{r}, t)
\end{align}
...
\begin{align}
  ...
  \eqcolon \frac1{4\pi k_e} \chi_e \v{E}
\end{align}
Confrontiamo la relazione appena ottenuta con 
\begin{align}
  \v{P} = \frac1{4\pi k_e} (\eps_r - 1)\v{E}
\end{align}
e otteniamo che la costante dielettrica relativa rispetta la relazione
\begin{align}
  \chi_e = \eps_r - 1 = \frac{4\pi k_e n \alpha}{ \left( 1 - \frac{4\pi k_e n \alpha}{3} \right)} \implies \frac{\eps_r - 1}{\eps_r + 2} = \frac{4\pi k_e}{3}n\alpha
