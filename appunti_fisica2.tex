...
Consideriamo il mezzo "vuoto" come un mezzo semplice, cioè non assorbente, mentre il mezzo di trasmissione lo consideriamo non magnetico quindi con 
...
\begin{align}
  ...
  \\
  &\implies B_x = \frac{k_z}{\omega} E_y \quad B_z = -\frac{k_x}{\omega} E_y
\end{align}
...
\begin{align}
  E_t = \frac{2k_{iz}}{k_iz + k_tz}\, E_i
  \\
  E_r = \frac{k_{iz} - k_{tz}}{k_{iz} + k_{tz}}\, E_i
\end{align}
che sono detti \textit{coefficienti di Fresnel}.
