...
campi e un certo flusso uscente dal volume. Questa quantità viene definita come \textit{vettore di Poynting} $ \mathbf{ S } $:
\begin{align}
...
\begin{align}
  &\v{D} = \eps_0 \v{E} + \v{P} = \eps_0 (1 + \chi_e) \v{E} \eqcolon \eps \v{E}  \tag*{[\textnormal{SI}]}
  \\
  &\v{D} = 4\pi \v{P} + \v{E} = \left( 1 + 4\pi \chi_e \right) \v{E} \eqcolon \eps \v{E} \tag*{[\textnormal{cgs}]}
\end{align}
...
\input{build/figure/effetti_campo_locale.tex}
...
sul punto considerato: ussiamo il modello descritto in figura \ref{figure:_effetti_campo_locale} dove il campo nel punto verrà indicato 
...
elettroni,
\begin{align}
  \v{P} = n \alpha \v{E}_{\text{loc}} = n\alpha (\v{E} + \frac{4\pi k_e}{3} \v{P}) \implies \v{P} = \frac{n \alpha}{1 - \frac{4\pi k_e n \alpha}{3} } \v{E} 
...
\begin{align}
  \eps_r - 1 = \frac{4\pi k_e n \alpha}{ \left( 1 - \frac{4\pi k_e n \alpha}{3} \right)} \implies \frac{\eps_r - 1}{\eps_r + 2} = \frac{4\pi k_e}{3}n\alpha
...
\begin{align}
  W = \int_V \v{J \cdot E} \,d^3x = \int_V \v{E} \cdot \left( \nabla\!\times\!\mathbf{ H } \right) - \v{E} \cdot \der{\v{D}}{t} \, d^3x.
\end{align}
Addesso applichiamo l'identità vettoriale
\begin{align}
...
assorbimento, in questo modo possiamo riconoscere nell'espressione che abbiamo ottenuto la derivata di una quantita $ u $ che definiremo come la 
...
$ \v{S} = \v{E \times H} $ e la nuova densità di energia ed il teorema è lo stesso solo che le quantità in gioco sono una media mesoscopica di quelle 
microscopiche. Tuttavia se volesso invece definire un teorema di Poynting microscopico, allora sarebbe esattamente quello definito 
...
\begin{align}
  \eps_r(\omega) = 1 + \frac{g_\omega}{\eps_0} = 1 + \frac{\omega_p^2}{\omega_0^2 - \omega^2 - i \gamma \omega}
\end{align}
...
\end{align}
In generale per i nostri scopi vale la relazione per l'indice di rifrazione, considerando $ \mu_r \simeq 1 $,
\begin{align}
  n(\omega) \simeq \sqrt{\eps_r (\omega)}.
\end{align}
