...
ragioni la funzione $ \chi(\omega) $ è \textit{olomorfa}. \input{build/figure/kramers-kronig.tex}
...
\begin{align}
  \begin{cases}
    \DS \chi_1(\omega_0) =\frac1\pi \int_{-\infty}^{+\infty} \frac{\chi_2(\omega)}{\omega - \omega_0} \,d\omega 
    \\
    \DS \chi_2(\omega_0) = - \frac1\pi \int_{-\infty}^{+\infty} \frac{\chi_1(\omega)}{\omega - \omega_0} \,d\omega 
  \end{cases} \tag*{[Kramers-Kronig]}
\end{align}
che sono dette \textit{relazioni di Kramers-Kronig}.
