...
\begin{align}
  ...
  = k_m \int  \frac{\v{ J }_\omega(\v{ r' }) e^{-i\omega t_r}}{|\v{x-x'}|} e^{i\omega t} \,d^3r' 
  = k_m \int  \frac{\v{ J }_\omega(\v{ r' })}{|\v{x-x'}|} e^{i\frac{\omega}{c} |\v{x - x'}| } \,d^3r' 
  \\
...
\dots
\begin{align}
  V(\v{ x },t) = k_e \frac{q}{r - \frac{\v{ v }\cdot \v{ r }}{c}}
\end{align}
ed è immediato il potenziale vettore
\begin{align}
  \v{ A }(\v{ x },t) = k_m \frac{ q \v{ v }}{r - \frac{\v{ v }\cdot \v{ r }}{c}}
\end{align}
...
\begin{align}
  A^\mu \coloneq \left( V, c \v{A} \right) \footnotemark
\end{align}
\footnotetext{Può essere definito anche come $ A^\mu = (V/c, \v{A}) $ con una conseguente 
...
\end{align}
dove $ {\delta^\mu}_\rho $ è la delta di Kronecker. In relatività la $ \delta $ è definità come quella a cui siamo abituati solo quando ha un indice alto 
e uno basso, cioè
\begin{align}
  \delta^\mu{}_\nu = 
  \begin{cases}
